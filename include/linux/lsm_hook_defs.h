...
/*
 * Linux Security Module hook definitions.
 *
 * Keep this file free of include guards: it is intentionally included
 * multiple times with different definitions of LSM_HOOK.
 */
...
LSM_HOOK(int, 0, sb_parse_opts_str, char *options,
	 struct security_mnt_opts *opts)
LSM_HOOK(int, 0, dentry_init_security, struct dentry *dentry, int mode,
...
LSM_HOOK(int, 0, inode_init_security, struct inode *inode, struct inode *dir,
...
LSM_HOOK(int, 0, inode_rename, struct inode *old_dir,
...
LSM_HOOK(void, LSM_RET_VOID, msg_queue_free_security, struct msg_queue *msq)
...
LSM_HOOK(int, 0, msg_queue_msgsnd, struct msg_queue *msq, struct msg_msg *msg,
	 int msqflg)
LSM_HOOK(int, 0, msg_queue_msgrcv, struct msg_queue *msq, struct msg_msg *msg,
...
LSM_HOOK(int, -EINVAL, getprocattr, struct task_struct *p, char *name,
	 char **value)
LSM_HOOK(int, -EINVAL, setprocattr, struct task_struct *p, char *name,
...
LSM_HOOK(int, 0, inode_notifysecctx, struct inode *inode, void *ctx,
	 u32 ctxlen)
LSM_HOOK(int, 0, inode_setsecctx, struct dentry *dentry, void *ctx, u32 ctxlen)
LSM_HOOK(int, 0, inode_getsecctx, struct inode *inode, void **ctx, u32 *ctxlen)
...
LSM_HOOK(int, 0, socket_getsockopt, struct socket *sock, int level,
	 int optname)
...
LSM_HOOK(int, 0, socket_getpeersec_stream, struct socket *sock,
	 char __user *optval, int __user *optlen, unsigned int len)
LSM_HOOK(int, 0, socket_getpeersec_dgram, struct socket *sock,
	 struct sk_buff *skb, u32 *secid)
LSM_HOOK(int, 0, sk_alloc_security, struct sock *sk, int family,
	 gfp_t priority)
LSM_HOOK(void, LSM_RET_VOID, sk_free_security, struct sock *sk)
LSM_HOOK(void, LSM_RET_VOID, sk_clone_security, const struct sock *sk,
	 struct sock *newsk)
LSM_HOOK(void, LSM_RET_VOID, sk_getsecid, struct sock *sk, u32 *secid)
LSM_HOOK(void, LSM_RET_VOID, sock_graft, struct sock *sk,
