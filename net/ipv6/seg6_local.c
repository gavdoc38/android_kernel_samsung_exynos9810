...
static struct ipv6_sr_hdr *get_srh(struct sk_buff *skb)
{
	...
	/* pskb_may_pull() may relocate the packet data. */
	srh = (struct ipv6_sr_hdr *)(skb->data + srhoff);
...
static int seg6_lookup_any_nexthop(struct sk_buff *skb,
...
static int seg6_local_build_state(struct net_device *dev, struct nlattr *nla,
